...
//         const clienteNombre = `${ordenInfo.orden.cliente.nombre} ${ordenInfo.orden.cliente.apellido}`;
...
//                 if (presupuesto_uuid) {
//                     botones = `
//                         <a href="#" data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-presupuesto-url="${urls.aceptar_presupuesto + ordenInfo.presupuesto_uuid}" data-cliente-nombre="${clienteNombre}"><i class="fa-solid fa-circle-check aceptada"></i></a>
//                         <a href="${urls.rechazar_presupuesto + ordenInfo.presupuesto_uuid}"><i class="fa-regular fa-circle-xmark rechazada"></i></a>
//                         `;
//                     console.log(botones)
//                 }
//                 break;
//             //     botones = `  <a href=# data-bs-toggle="modal" data-bs-target="#staticBackdrop" data-presupuesto-url="${urls.aceptar_presupuesto}${presupuesto_uuid}" data-cliente-nombre="{% if orden_info.cliente.empresa %}{{ orden_info.cliente.razon_social }}{% endif %}{{ orden_info.cliente.nombre }} {{ orden_info.cliente.apellido }}"><i class="fa-solid fa-circle-check aceptada"></i></a>
//             // <a href="${urls.rechazar_presupuesto}${presupuesto_uuid}"><i class="fa-regular fa-circle-xmark rechazada"></i></a>`
//             // }
