...
#     p.drawString(3 * cm, height - header_height - 3.9 * cm, datos['cliente_email'])
...
#     p.drawString(width - 9 * cm, height - header_height - 2.4 * cm, f"Fecha de Ingreso: {datos['ingreso_fecha']}")

#     # Configuración de la tabla de datos del equipo
#     table_data = [
#         ['DETALLE EQUIPO', '', '', '', '' ],
...
#     table_data = [
#         ['DESCRIPCION'],
#         [datos['presupuesto_descripcion']],
#         [f'TOTAL: ${datos["presupuesto_total"]}']
#     ]
